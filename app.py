...
def get_analysis(mic_id):
    ...
    elif max_amplitude < 1000: # Arbitrary low thresholdc:\Users\saija\AppData\Local\Packages\MicrosoftWindows.Client.Core_cw5n1h2txyewy\TempState\ScreenClip\{AF19874C-51A2-4607-8EDD-6C0B5F51B32A}.png
